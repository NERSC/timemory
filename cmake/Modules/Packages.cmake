...
if(CMAKE_CXX_COMPILER_IS_GNU)
    ...
    if(GCOV_LIBRARY OR CMAKE_CXX_COMPILER_IS_GNU)
        add_flag_if_avail("-ftest-coverage" timemory-coverage)
        add_flag_if_avail("-fprofile-arcs" timemory-coverage)
        ...
        target_link_libraries(timemory-headers INTERFACE timemory-coverage)
    endif()

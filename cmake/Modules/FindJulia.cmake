...
# https://github.com/QuantStack/xtensor-julia-cookiecutter/blob/master/%7B%7Bcookiecutter.github_project_name%7D%7D/cmake/FindJulia.cmake
...
if(Julia_EXECUTABLE)
    ...
    find_library(
        Julia_LIBRARY
        NAMES libjulia.${Julia_VERSION_STRING}.dylib julia libjulia libjulia.dll.a
...
if(Julia_EXECUTABLE)
    ...
    execute_process(COMMAND ${Julia_EXECUTABLE} --startup-file=no -E
                            "Base.libllvm_version" OUTPUT_VARIABLE Julia_LLVM_VERSION)
